...
public class MemberRepositoryList implements MemberRepository {
    ...
    public MemberDTO login(String memberEmail, String memberPass) {
        ...
        for (int i = 0; i < memberDTOList.size(); i++) {
            if (memberEmail.equals(memberDTOList.get(i).getMemberEmail()) && memberPass.equals(memberDTOList.get(i).getMemberPassword())) {
    ...
    @Override
    public boolean upadate(String loginEmail, String mobile) {
        return false;
    }
